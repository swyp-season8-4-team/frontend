...
export function SearchResultList({
  ...
  return (
    <BottomSheet isOpen={isResultListOpen} onClose={handleResultListClose}>
            ...
            >
              <div className="w-full flex flex-col justify-center gap-[px] md:gap-[11px] ">
                ...
                <div className="flex gap-[18px] items-center">
                  <div className="text-xs md:text-xl font-semibold">170m</div>
                  <div className="text-[10px] md:text-xl">{store.address}</div>
                </div>
                <div className="flex gap-[18px] items-center">
