...
export function CommunityReviewTab({
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex items-center bg-[#F6F6F6] p-[8px] md:px-[14px] md:py-3 w-full">
          ...
          <div className="flex flex-col justify-center gap-[1px]">
            <div className="flex items-center w-full justify-between">
              <div className="flex  flex-shrink-0 items-center gap-x-[1px] gap-y-1 md:gap-x-[5px] md:gap-y-[7px]">
                ...
                <div className="text-[8px] md:text-base">닉네임</div>
              </div>
              <div className="flex w-full justify-end">
                <div className="text-[8px] md:text-base">25.01.23</div>
              </div>
            </div>
