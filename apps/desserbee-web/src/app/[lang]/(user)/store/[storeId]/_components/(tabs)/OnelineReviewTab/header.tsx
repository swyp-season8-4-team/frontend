  ...
  return (
    <div className="flex justify-between items-center gap-x-[2px] ">
      <div className="flex items-center">
        <div className="mr-[2px] md:mr-2 font-semibold text-[10px] md:text-lg">
          한 줄 리뷰
        </div>
        <div className="mr-[2px] md:mr-[8px] text-[#898989] text-[8px] md:text-[14px]">
          {totalReviewCount}명 참여
        </div>
        <div className="md:mr-[2px] w-[9px] md:w-[17px] h-[9px] md:h-[17px]">
          <IconStar className="w-full h-full text-[#FFB700]" />
        </div>
        <div className="text-[8px] md:text-base">{averageRating}</div>
      </div>
      {handleWriteReviewBtnClick && (
        <button
