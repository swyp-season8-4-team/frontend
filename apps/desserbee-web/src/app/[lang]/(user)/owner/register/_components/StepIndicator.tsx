  ...
  return (
    <div className="px-base w-full py-[14px]">
      <div className="relative mx-auto">
        {/* 프로그레스 바 컨테이너 */}
        <div className="mb-[10px] h-[7px] w-full rounded-[99px] bg-[#EEEBE6]">
          {/* 진행률 표시 */}
          <div
            className="bg-primary-70 h-full rounded-[99px] transition-all duration-300"
            style={{ width: `${calculateProgress()}%` }}
          />
        </div>

        {/* 단계 인디케이터 */}
        <div className="text-neutral-40 flex w-full justify-end text-sm font-medium">
