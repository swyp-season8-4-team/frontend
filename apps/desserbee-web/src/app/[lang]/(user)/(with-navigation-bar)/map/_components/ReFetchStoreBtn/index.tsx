...
export default function ReFetchStoreBtn({
  ...
  return (
    ...
    >
      <div className="shadow-base flex items-center gap-2 rounded-[24px] bg-white px-4 py-2 font-medium">
        <div className="h-4 w-4">
          <IconRetry className="h-full w-full text-lg text-[#3374ff]" />
        </div>
        <div className="semi-bold text-nowrap text-lg text-[#3374ff]">
          현 위치에서 새로고침
        </div>
      </div>
    </button>
