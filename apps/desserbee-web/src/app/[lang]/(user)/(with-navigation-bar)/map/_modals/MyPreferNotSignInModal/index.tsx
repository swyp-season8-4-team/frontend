...
export function MyPreferNotSignInModal({
  ...
  return (
    <CustomModal onClose={onClose}>
      <div className="text-nowrap flex flex-col justify-center items-center p-5 w-[200px] md:w-[357px] min-w-fit h-[180px] md:h-[298px]">
        <div className="flex flex-col justify-center items-center md:gap-3 w-full h-full">
          <div className="md:text-[26px]">취향 선택은 로그인 후</div>
