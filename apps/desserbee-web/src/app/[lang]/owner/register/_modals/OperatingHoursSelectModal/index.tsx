    ...
    <div className="fixed bottom-0 left-0 right-0 top-0 z-10 flex h-full w-full flex-col bg-white">
      ...
      <div>
        <div className="w-full border-b border-b-[#D3D3D3] py-[10px]">
          <div className="px-base mb-[10px] font-semibold">영업일 선택</div>
          {/* 요일 선택 버튼 */}
          <div className="px-base flex justify-center gap-[14px]">
            {DAYS_OF_WEEK.map((day) => (
              <button
                ...
                className={`h-[34px] w-[34px] rounded-full border text-center text-[14px] md:h-12 md:w-12 ${
        ...
        <div className="p-4">
          <div className="mb-2 flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <input type="checkbox" onClick={() => setIs24Hour(!is24Hour)} />
