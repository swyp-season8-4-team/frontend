  ...
  implements StoreRepository
{
  ...
  async createCoupon({
    ...
    const { storeUuid, ...rest } = data || {};
    const url = `${this.endpoint}/coupons/create/${storeUuid}`;

    const response = await fetch<
      Omit<RegisterCouponRequest, 'storeUuid'>,
      void
    >({
      ...(authorization && {
        headers: {
  ...
  async getCoupon({
    ...
    const response = await fetch<getCouponRequest, getCouponResponse[]>({
      ...(authorization && {
        headers: {
          Authorization: authorization,
        },
  ...
  async getPeriodTrendStats({
    ...
    const response = await fetch<getPeriodStatsRequest, getPeriodTrendStatsResponse[]>(
      {
        ...(authorization && {
          headers: {
            Authorization: authorization,
        ...
        method: 'GET',
        url: `${this.endpoint}/stores/${storeUuid}/statistics/trend`,
        query: { period, date },
      },
    );
